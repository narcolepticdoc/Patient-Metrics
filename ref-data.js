...
function computeRef(item, d) {
  ...
  switch (item.calc) {
    ...
    case 'occ_multi': { // OCC multiple computed lines, optionally filtered by age
      var lines = [];
      var isPeds = age !== null && age < 18;
      var isAdult = age !== null && age >= 18;
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Atropine', calc: 'occ_multi', params: { rows: [
          { type: 'ws', age: 'peds', label: 'Peds (0.02 mg/kg)', f: 0.02, u: 'mg' },
          { type: 'wr', label: 'Pretreatment', lo: 0.01, hi: 0.02, u: 'mg' },
          { type: 'txt', age: 'adult', v: 'Adult arrest: 1 mg q3-5 min' }
      ...
      { label: 'Epinephrine', calc: 'occ_multi', params: { rows: [
          ...
          { type: 'txt', age: 'adult', v: 'Adult hypotension: 5-20 mcg IV' },
          { type: 'ws', age: 'peds', label: 'Peds arrest', f: 0.01, u: 'mg' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Midazolam', calc: 'occ_multi', params: { rows: [
          { type: 'txt', age: 'adult', v: 'Adult: 0.5-2 mg IV titrate' },
          { type: 'wr', age: 'peds', label: 'Peds', lo: 0.05, hi: 0.1, u: 'mg' }
  ...
  },
  {
    ...
    items: [
      { label: 'Cefazolin', calc: 'occ_multi', params: { rows: [
          { type: 'txt', age: 'adult', v: 'Adult: 2 g IV (3 g if >120 kg)' },
          { type: 'ws', age: 'peds', label: 'Peds', f: 30, u: 'mg; Redose q4h' }
      ...
      { label: 'Metronidazole', calc: 'occ_multi', params: { rows: [
          { type: 'txt', age: 'adult', v: 'Adult: 500 mg IV' },
          { type: 'ws', age: 'peds', label: 'Peds', f: 15, u: 'mg; No redose' }
